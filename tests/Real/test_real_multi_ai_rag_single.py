...
# Re-enforce REAL AI mode after imports (to override any module-level load_dotenv calls)
set_real_ai()

def run_test():
    print("[STEP R5-5] Starting Real Multi-AI + RAG E2E Integration Test")
    ...
    name = candidate_df.iloc[0]['name']
    market = candidate_df.iloc[0]['market']
    ...
    print(f"[INFO] Running E2E for candidate: {ticker} ({name})...")
